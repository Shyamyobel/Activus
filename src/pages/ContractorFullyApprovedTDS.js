...
const ContractorFullyApprovedTDS = () => {
  ...
  const handleUploadToS3 = async (tdsId) => {
    setIsLoading(true);
    setError('');
    setSuccess('');
  ...
  {tds.documentPath ? (
    ...
    <span>No Documents</span>
                  ...
                  <td style={styles.td}>
                    <button
                      onClick={() => handleUploadToS3(tds.tdsId)}
              ...
              <tr>
                <td colSpan="5" style={styles.noTDS}>
                  No fully approved TDS found for your projects.
                </td>
              </tr>
            )}
          </tbody>
...
export default ContractorFullyApprovedTDS;